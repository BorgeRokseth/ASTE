...
if __name__ == "__main__":
    ...
    initial_states_third_ship = SimulationConfiguration(
        ...
        initial_yaw_angle_rad=-70 * np.pi / 180,
    ...
    third_target_ship = test_target_factory.make_target_ship(start_time=200, initial_states=initial_states_third_ship)
    ...
    while own_ship.int.time <= own_ship.int.sim_time:
        ...
        #                                      sway_velocity_obstacle__v0=third_target_ship.ship_model.sideways_speed)
        #
                ...
                if global_time <= target_ship.sim_time:
                    ...
                    if target_ship == third_target_ship:
                        dynamic_values_ca = UpdatedVariables(north__x=third_target_ship.ship_model.north,
                                                             ...
                                                             sway_velocity_obstacle__v0=own_ship.sideways_speed)
